...
def attackDumpedTable():
    if kb.data.dumpedTable:
        ...
        if attack_dict:
            ...
            message = "do you want to crack them via a dictionary-based attack (ALTERED)? %s" % ("[y/N/q]" if conf.multipleTargets else "[y/N/q]")
            test = readInput(message, default="N" if conf.multipleTargets else "N")
